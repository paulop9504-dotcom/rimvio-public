...
export const STORE_LAUNCH = {
  ...
  ios: {
    ...
    liveActivityWidget: {
      swift: "ios/RimvioLiveActivityWidget/RimvioLiveActivityWidget.swift",
      plist: "ios/RimvioLiveActivityWidget/Info.plist",
      sharedAttributes: "ios/Shared/RimvioMainSurfaceAttributes.swift",
      controller: "ios/App/App/RimvioMainSurfaceLiveActivityController.swift",
      extensionBundleId: "com.rimvio.app.RimvioLiveActivityWidget",
      pbxTargetName: "RimvioLiveActivityWidget",
    },
